...
async function addJournalTool() {
    const toolName = 'nature_index_journal_lookup';
    const description = 'Check if a journal is in the Nature Index list of 145 elite journals.';

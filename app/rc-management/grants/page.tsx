            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-6">
                    ...
                    <p className="text-[#94A3B8] font-['JetBrains_Mono',monospace] text-sm">
                        // TRACK_RESEARCH_GRANTS_AND_FUNDING
                    </p>
                </div>
                                ...
                                <div className="mt-4 bg-slate-900/80 backdrop-blur-xl rounded-lg border border-white/20 p-4 shadow-[0_0_15px_rgba(255,255,255,0.07)]">
                                    ...
                                    <div className="flex flex-row gap-2">
                                        ...
                                        <label className="cursor-pointer flex-1">
                                            ...
                                            />
                                            <div className={`px-4 py-2 transition font-['JetBrains_Mono',monospace] text-sm text-center uppercase tracking-wider font-bold ${uploadingStates.inUtar
                                                ? 'bg-[#1E293B] border-2 border-emerald-500/50 text-emerald-300 cursor-wait shadow-[0_0_10px_rgba(16,185,129,0.3)]'
                                                : 'bg-[#1E293B] border-2 border-emerald-500 text-emerald-400 hover:bg-emerald-500 hover:text-white shadow-[0_0_10px_rgba(16,185,129,0.3)] hover:shadow-[0_0_20px_rgba(16,185,129,0.6)]'
                                                }`}>
                                        ...
                                        <label className="cursor-pointer flex-1">
                                            <input
                                                ...
                                                disabled={uploadingStates.inUtar || uploadingStates.notInUtar}
                                            />
                                            <div className={`px-4 py-2 transition font-['JetBrains_Mono',monospace] text-sm text-center uppercase tracking-wider font-bold ${uploadingStates.notInUtar
                                                ? 'bg-[#1E293B] border-2 border-amber-500/50 text-amber-300 cursor-wait shadow-[0_0_10px_rgba(245,158,11,0.3)]'
                                                : 'bg-[#1E293B] border-2 border-amber-500 text-amber-400 hover:bg-amber-500 hover:text-white shadow-[0_0_10px_rgba(245,158,11,0.3)] hover:shadow-[0_0_20px_rgba(245,158,11,0.6)]'
                                                }`}>

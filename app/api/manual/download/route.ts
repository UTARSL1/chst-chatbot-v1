...
<head>
  <meta charset="UTF-8">
  <title>CHST Chatbot - ${requestedRole.charAt(0).toUpperCase() + requestedRole.slice(1)} User Manual</title>
  <style>
    @page {
      size: A4;
      margin: 2cm;
...
<body>
  ${htmlContent}
    ...
    headers.set('Content-Disposition', `attachment; filename="CHST-Chatbot-${requestedRole}-Manual.html"`);

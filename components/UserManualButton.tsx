                                ...
                                <div className="prose prose-blue max-w-none">
                                    <ReactMarkdown
                                        components={{
                                            ...
                                            h2: ({ children }) => (
                                                <h2 className="text-2xl font-bold text-blue-800 border-b border-blue-100 pb-2 mt-6 mb-3">
                                                    {children}
                                                </h2>
                                            ),
                                            h3: ({ children }) => (
                                            ...
                                            th: ({ children }) => (
                                                <th className="px-4 py-2 bg-blue-600 text-white text-left font-semibold">
                                                    {children}
                                                </th>
                                            ),
                                            td: ({ children }) => (

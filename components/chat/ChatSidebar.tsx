                    ...
                    <div className="p-4 space-y-6">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between">
                                <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider flex items-center gap-2">
                                    <ExternalLink className="w-3.5 h-3.5" /> Quick Access
                                </h3>
                                <button onClick={onAddLink} className="p-1 hover:bg-accent rounded text-muted-foreground hover:text-foreground" title="Add Link">
                            ...
                            <div className="space-y-2">
                                {/* RC System Links */}
                                {hasRCAccess(session.user.email, session.user.role) && customLinks
